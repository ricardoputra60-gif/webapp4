...
const SignUp: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try{
      const response = await fetch ('http://api.servernikki.my.id/api/accounts', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
        body: JSON.stringify({username,email,password,rekening})
      });
      ...
      setError('Daftar Rekening berhasil!');
    } catch (error) {
