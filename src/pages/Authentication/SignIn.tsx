...
const SignIn: React.FC = () => {
  ...
  const [error, setError] = useState(''); // Ganti nama state ke setError
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await fetch('http://api.servernikki.my.id/api/login', {
        method: 'POST',
        mode: "cors",
        headers: {
      ...
      // Periksa apakah respons status OK (200-299)
      if (!response.ok) {
        // Jika respons status bukan OK, lemparkan error
      ...
      Cookies.set('account_id', data.account.account_id, { expires: 1});
      Cookies.set('username', data.account.username), { expires: 1};
      Cookies.set('rekening', data.account.rekening, { expires: 1});

      // Arahkan ke halaman yang sesuai setelah login
      navigate('/');
      setError('Login berhasil!'); // Ubah nama state untuk pesan sukses jika perlu
  ...
  return (
    <>
      <div className="m-20 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">Internet Banking Fake</span>
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                Sign in to fake RML Bank
              </h2>
